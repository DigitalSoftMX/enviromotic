$(function () {
    ...
    var items = 0;
    var itemss= 1;
    var dataTable_Cancelacion_Requesitions =

       $("#tabla_Cancelacion_Requisitions").dataTable({
    ...
    function obtenerlistaclaves(id) {
        ...
        if (id === null) {
            $.ajax({
                url: '../ajax_listaProveedor_requisition',
                type: 'GET',
                dataType: 'json',
                    ...
                    $("#proveedor")
                            ...
                            .select2(
                               ...
                               obtenerProductoxNombre(select_val);
                                var table = $('#tabla_Cancelacion_Requisitions').DataTable();
                                table.clear().draw();
            ...
            $.ajax({
                url: '../ajax_listaProveedor_requisition' + idProd,
                type: 'GET',
                dataType: 'json',
                success: function (data) {
                    $("#proveedor")
    ...
    function obtenerProductoxNombre(id) {
          var row_data = [];
        $.get('../ajax_listaorden_requisitions/' + id, function (data) {
          ...
          if (detalle != 0 ) {
              ...
              row_data.push([
                      ...
                      detalle[i].CantidadPendiente,
                      detalle[i].idDetalle,
                      detalle[i].id_requisicion
                            ]);
                     }
            dataTable_Cancelacion_Requesitions.fnAddData(row_data)
          }else{
