...
function view_supplier(id_supplier)
  {
       ...
       var ruta = "../supplier/"+id_supplier.value+"";
      // alert(ruta);
        $.ajax({
          url: ruta,
          dataType: "JSON",
 ...
 function product(id_product,id_descripcion)
    {
        var id_items = id_product;
      
        var url_action ="../items/products/"+id_items+"";

		        /* Para obtener el texto */
	//	var combo = document.getElementById("id_producto_almacen");
	//	var selected = combo.options[combo.selectedIndex].text;
var selected =id_descripcion;
                $.ajax({
                     url:url_action,
                     dataType: 'JSON',
                     type:'GET',
...
function valor_contenido()
    {
          ...
          var url_action_clave ="../search_key_products/"+id_presentacion+"/"+id_unidad+"/"+id_productos+"/"+valor_cantidad+"";
         ...
         var sub_total_iva = 0;
          ...
          var outHTML =
		        '<tr class="ingData" id="ingRow' + rowCount + '">'
		            ...
		            + '<td align="right"><div class="input-group m-b"><span class="input-group-addon">$</span><input type="text" class="form-control alin" data-id="'+rowCount+'" name="precio_row['+ items +']" id="precio_row' + rowCount + '" value="' + precio + '" onkeyup="suma_row_table_price(this);"/></div></td>'
                ...
                + '<td style="display:none;"><input type="text" class="form-control alin" data-id="'+rowCount+'" name="iva_row['+ items +']" id="iva_row' + rowCount + '" value="' + iva + '" /></td>'
		            ...
		            + '<td style="width:130px " align="center"><div class="input-group m-b"><span class="input-group-addon sinborder">$</span><input type="text" class="sin_border suma_total form-control alin2" name="sub_total_row['+ items +']" id="sub_total_row' + rowCount + '" value="' + sub_total + '" readonly/></div></td>'
                ...
                +'<td style="display:none;"><input type="number" name="id_requisicion_item['+ items +']" id="id_requisicion_item' + rowCount + '" value="0"/></td>'

                +'<td style="display:none;"><input type="number" name="id_requisicion_item_detalle['+ items +']" id="id_requisicion_item_detalle' + rowCount + '" value="0"/></td>'
     ...
     function myDeleteFunction(renglon) 
		{
           ...
           var  renglo_delete = $('#id_items_items'+renglon.value).val();
           var renglon_update = $('#id_requisicion_item_detalle'+renglon.value).val(); 

//alert(renglo_delete + ' ' + renglon_update)
if(renglo_delete == 0)
         {
              ...
              bootbox.confirm({ 
                size: 'medium',
                message: "<div class='row'> <div class='col-md-2'><img alt='image' class='img-circle' src='../img/delete.png' width='50px'/></div><div class='col-md-10'><p class='text-primary' style='font-weight: bold; font-size: 15px; font-style: italic;'>DESEA ELIMINAR EL PRODUCTO DE LA LISTA.</p></div></div>",
                 title: '<p class="text-primary" style="font-weight: bold; font-size: 16px; font-style: italic; color: #B30606;">ALERTA</p>',
                buttons: {
           ...
           //alert("hola");
             var token = $("#token").val();
               ...
               bootbox.confirm({ 
                  size: 'medium',
                  message: "<div class='row'> <div class='col-md-2'><img alt='image' class='img-circle' src='../img/delete.png' width='55px'/></div><div class='col-md-10'><p class='text-primary' style='font-weight: bold; font-size: 15px; font-style: italic;'>DESEA ELIMINAR EL PRODUCTO DE LA LISTA.</p></div></div>",
                   title: '<p class="text-primary" style="font-weight: bold; font-size: 16px; font-style: italic; color: #B30606;">ALERTA</p>',
                  buttons: {
                  ...
                  callback: function(result){ 
                    ...
                    {
                      $.ajax({
                          url:"../delete_item/"+renglo_delete+"/"+renglon_update+"",
      ...
      function suma_col()
    {
      ...
      //    iva_suma = iva_suma.replace("$","''");
        ...
        var suma_general = 0;
          ...
          if(g_total.text() != ''){
              g_total.html(g_total.text().replace('$','').replace(',',''));
            // alert(suma_general);
          }else{
             g_total.html("");
             suma_general = 0;
...
function view_requisition(id_req_alm)
{
      ...
      var ruta = "../items/"+id_req_alm.value+"";
      var item_data = $('#item_data').val();
   ...
   //////////////////////////////////////////////////////
       ...
       table_invoice_items.append('<tr class="ingData" id="ingRow'+rowCount+'">'
            ...
            + '<td align="center" style="display:none;"><input type="text" id="ids_row'+rowCount+'" name="ids_row['+ itemss +']" value="' + itemss + '"></td>'
		     ...
		     + '<td align="right"> <div class="input-group m-b"><span class="input-group-addon">$</span><input type="text" class="form-control alin" data-id="'+rowCount+'" name="precio_row['+ itemss +']" id="precio_row' + rowCount + '" value="' + value.precio + '" onkeyup="suma_row_table_price(this);"/></div></td>'
         ...
         + '<td style="display:none;"><input type="text" class="form-control alin" data-id="'+rowCount+'" name="iva_row['+ itemss +']" id="iva_row' + rowCount + '" value="' + iva + '" /></td>'
		     ...
		     + '<td style="width:130px" align="center"><div class="input-group m-b"><span class="input-group-addon sinborder">$</span><input type="text" class="sin_border suma_total form-control alin2" name="sub_total_row['+ itemss +']" id="sub_total_row' + rowCount + '" value="' + sub_total + '" readonly/></div></td>'
		     ...
		     + '<td style="display:none;" ><input type="number" name="id_items_items['+ itemss +']" id="id_items_items' + rowCount + '" value="0"/></td>'

        //  + '<td ><input type="number" name="id_items_items['+ itemss +']" id="id_items_items' + rowCount + '" value="' + value.id + '"/></td>'

         + '<td style="display:none;" ><input type="number" name="id_requisicion_maestro['+ itemss +']" id="id_requisicion_maestro' + rowCount + '" value="0"/></td>'

		    //+ '<td ><input type="number" name="id_requisicion_maestro['+ itemss +']" id="id_requisicion_maestro' + rowCount + '" value="' + id_req_alm.value + '"/></td>'
          
         +'<td style="display:none;"><input type="number" name="id_requisicion_item['+ itemss +']" id="id_requisicion_item' + rowCount + '" value="' + id_req_alm.value + '"/></td>'

         +'<td style="display:none;"><input type="number" name="id_requisicion_item_detalle['+ itemss +']" id="id_requisicion_item_detalle' + rowCount + '" value="' + value.id + '"/></td>'
  ...
  function services_add()
    { //llave
       ...
       // var iva = $('#iva_servicio').val();
        var iva = $("#iva_servicio option:selected").text();
        var subtotal = 0;
        var sub_total_iva = 0;
                   ...
                   if(rowCount == 0)
                        ...
                        var outHTML =
                          '<tr class="ingData" id="ingRowSer' + rowCount + '">'
                              ...
                              + '<td align="right"><input type="text" class="form-control alin" data-id="'+rowCount+'" name="cantidad_row_ser['+ items_service +']" id="cantidad_row_ser' + rowCount + '" value="' + cantidad + '"  onkeypress="return isNumberKey(this);" onkeyup="suma_row_cantidad(this);"/></td>'

                              + '<td align="right"><div class="input-group m-b"><span class="input-group-addon">$</span><input type="text" class="form-control alin" data-id="'+rowCount+'" name="precio_row_ser['+ items_service +']" id="precio_row_ser' + rowCount + '" value="' + precio + '" onkeyup="suma_row_precio(this);"/></div></td>'

                              + '<td align="right"><div class="input-group m-b"><span class="input-group-addon">%</span><input type="text" class="form-control alin" data-id="'+rowCount+'" name="iva_row_ser['+ items_service +']" id="iva_row_ser' + rowCount + '" value="' + iva + '"  onkeypress="return isNumberKey(this);" onkeyup="suma_row_iva(this);"/></div></td>'

                              + '<td  align="right"><div class="input-group m-b"><span class="input-group-addon sinborder">$</span><input type="text" class="form-control alin2 sin_border suma_total_servicio" data-id="'+rowCount+'" name="subtotal_row_ser['+ items_service +']" id="subtotal_row_ser' + rowCount + '" value="' + subtotal + '"  onkeypress="return isNumberKey(this);" readonly/></div></td>'
                              ...
                              + '<td  align="right" style="display:none;"><input type="text" class="form-control alin2 sin_border" data-id="'+rowCount+'" name="id_requi_item_row['+ items_service +']" id="id_requi_item_row' + rowCount + '" value="0"  onkeypress="return isNumberKey(this);"/></td>'


                             + '<td style="display:none;"><input type="text" class="form-control alin2 sin_border" data-id="'+rowCount+'" name="id_requi_item_row_items['+ items_service +']" id="id_requi_item_row_items'+rowCount+'" value="0"  onkeypress="return isNumberKey(this);"/></td>'

				  	  		           + '<td style="display:none;"><input type="text" class="form-control alin2 sin_border" data-id="'+rowCount+'" name="id_requi_item_row_items_items['+ items_service +']" id="id_requi_item_row_items_items'+rowCount+'" value="0"  onkeypress="return isNumberKey(this);"/></td>'
                       ...
                       $('#precio_servicio').val("");
                        ...
                        $('#item_data_service').val(items_service+1);
     ...
     function myDeleteFunctionServicio(renglon) 
    {
          ...
          var  renglo_delete = $('#id_requi_item_row'+renglon.value).val();
          var renglon_update = $('#id_requi_item_row_items_items'+renglon.value).val(); 
   ...
   if(renglo_delete == 0)
         {
              ...
              bootbox.confirm({ 
                size: 'medium',
                message: "<div class='row'> <div class='col-md-2'><img alt='image' class='img-circle' src='../img/delete.png' width='50px'/></div><div class='col-md-10'><p class='text-primary' style='font-weight: bold; font-size: 15px; font-style: italic;'>DESEA ELIMINAR EL SERVICIO DE LA LISTA.</p></div></div>",
                 title: '<p class="text-primary" style="font-weight: bold; font-size: 16px; font-style: italic; color: #B30606;">ALERTA</p>',
                buttons: {
           ...
           //alert("hola");
             var token = $("#token").val();
               ...
               bootbox.confirm({ 
                  size: 'medium',
                  message: "<div class='row'> <div class='col-md-2'><img alt='image' class='img-circle' src='../img/delete.png' width='55px'/></div><div class='col-md-10'><p class='text-primary' style='font-weight: bold; font-size: 15px; font-style: italic;'>DESEA ELIMINAR EL SERVICIO DE LA LISTA.</p></div></div>",
                   title: '<p class="text-primary" style="font-weight: bold; font-size: 16px; font-style: italic; color: #B30606;">ALERTA</p>',
                  buttons: {
                  ...
                  callback: function(result){ 
                    ...
                    {
                      $.ajax({
                          url:"../delete_item_service/"+renglo_delete+"/"+renglon_update+"",
                          headers: {'X-CSRF-TOKEN': token},
                          dataType: 'JSON',
                          type:'GET',
                          success: function(response){
  ...
  function suma_iva_total()
  {
     ...
     var iva_total = 0;
          ...
          // iva_total = iva_suma.text().replace('$','');
            iva_suma.html(iva_suma.text().replace('$','').replace(',',''));
         }else{
            iva_suma.html("");
         	iva_total = 0;
...
function view_requisition_services(id_req_servicio)
{
      ...
      var ruta = "../items/services/"+id_req_servicio.value+"";
      var item_data_service = $('#item_data_service').val();
           ...
           var sub_total_iva = 0;
            ...
            $(res).each(function(key, value) {
               ...
               table_invoice_items_services.append( '<tr class="ingData" id="ingRowSer' + rowCount + '">'
                              ...
                              + '<td align="right"><input type="text" class="form-control alin" data-id="'+rowCount+'" name="cantidad_row_ser['+ itemss_services +']" id="cantidad_row_ser' + rowCount + '" value="' + value.cantidad + '"  onkeypress="return isNumberKey(this);" onkeyup="suma_row_cantidad(this);"/></td>'

                              + '<td align="right"><div class="input-group m-b"><span class="input-group-addon">$</span><input type="text" class="form-control alin" data-id="'+rowCount+'" name="precio_row_ser['+ itemss_services +']" id="precio_row_ser' + rowCount + '" value="' + precio + '"  onkeypress="return isNumberKey(this);" onkeyup="suma_row_precio(this);"/></div></td>'

                              + '<td><div class="input-group m-b"><span class="input-group-addon">%</span><input type="text" class="form-control alin" data-id="'+rowCount+'" name="iva_row_ser['+ itemss_services +']" id="iva_row_ser' + rowCount + '" value="' + iva + '"  onkeypress="return isNumberKey(this);" onkeyup="suma_row_iva(this);"/></div></td>'

                              + '<td  align="right"><div class="input-group m-b"><span class="input-group-addon sinborder">$</span><input type="text" class="form-control alin2 sin_border suma_total_servicio" data-id="'+rowCount+'" name="subtotal_row_ser['+ itemss_services +']" id="subtotal_row_ser' + rowCount + '" value="' + subtotal + '"  onkeypress="return isNumberKey(this);" readonly/></div></td>'
                             ...
                             + '<td style="display:none;"><input type="text" class="form-control alin2 sin_border" data-id="'+rowCount+'" name="id_requi_item_row_items['+ itemss_services +']" id="id_requi_item_row_items'+rowCount+'" value="' +id_req_servicio.value+ '"  onkeypress="return isNumberKey(this);"/></td>'

				  	  	   	         + '<td style="display:none;"><input type="text" class="form-control alin2 sin_border" data-id="'+rowCount+'" name="id_requi_item_row_items_items['+ itemss_services +']" id="id_requi_item_row_items_items'+rowCount+'" value="'+value.id+'"  onkeypress="return isNumberKey(this);"/></td>'

                              + '<td style="display:none;"><input type="number" name="id_servicio_maestro['+ itemss_services +']" id="id_servicio_maestro' + rowCount + '" value="0" class="form-control alin2 sin_border"/></td>'
     ...
     function product_clave(id_prod)
      {
          var id_elem = id_prod;
       //  alert(id_elem);
        
          var url_action ="../search_products_items_clave/"+id_elem+"";     
           ...
           $.ajax({
                ...
                success: function(resp){
                 ...
                 var is_producto =resp.productos_almacen[0].cat_producto_id;


                     $('#producto_nombre').val(resp.productos_almacen[0].cat_producto.Descripcion_corta);
                     $('#id_producto_almacen').val(resp.productos_almacen[0].cat_producto.Descripcion_corta);
                     $('#id_producto_requisicion').val(resp.productos_almacen[0].id);
                     $('#id_producto_id').val(resp.productos_almacen[0].cat_producto_id);

                      if((resp.unicos_presenta).length > 1)
                       {
                            select = '<select id="presentacion" name="presentacion" class="form-control">';
                              option = '<option> Seleccione una presentacion </option>';
                                  $.each(resp.unicos_presenta, function(index, value){
                                     option += '<option value="'+index+'">'+value+'</option>'; 
                                  });
                                $('#selectPresentacion').html(select + option + '</select>');
                                $('#id_select_presentacion').val("");
                        ...
                        if((resp.unicos_unidad).length > 1)
                                { 
                                     // $('.oculto').hide();
                                  select = '<select id="unidad_medida" name="unidad_medida" class="form-control">';
                                          option = '<option> Seleccione una presentacion </option>';
                                             $.each(resp.unicos_unidad, function(index, value){
                                               option += '<option value="'+index+'">'+value+'</option>'; 
                                             });
                                            $('#selectUnidad').html(select + option + '</select>');
                                            $('#id_select_unidad').val("");
                             ...
                             if((resp.cantidad).length > 1){
                                 ...
                                 $('#texto_contenido').val("");
                                        select = '<select id="contenido" name="contenido" class="form-control" onchange="valor_contenido();">';
                                          option = '<option> Seleccione un contenido </option>';
                                             $.each(resp.cantidad, function(index, value){
                                               option += '<option value="'+index+'">'+value+'</option>'; 
                                             });
                                            $('#selectContenido').html(select + option + '</select>');
                                             //$('#contenido').attr("readonly",'readonly');
                                             $('#precio').val("");
                                             $('#unico_cantidad').val("0");

                               }else{

                                     $('#selectContenido').html('<input type="text" name="contenido" id="contenido" class="form-control oculto" value="'+resp.cantidad+'" readonly>');
                                $('#texto_contenido').val(resp.cantidad);
                                 $('#codigoBarras').val(resp.cat_claves);
                                        $('#precio').val(resp.productos_almacen[0].precio);
                           ...
                           if((resp.unico_impuesto).length > 1){
                                  // alert("entro");
                                    select = '<select id="factor" name="factor" class="form-control">';
                                          option = '<option> Seleccione una Opcion </option>';
                                             $.each(resp.unico_impuesto, function(index, value){
                                               option += '<option value="'+index+'">'+value+'</option>'; 
                                             });
                                            $('#selectFactor').html(select + option + '</select>');
                                     ...
                                     $('#selectFactor').html('<input type="number" name="factor" id="factor" class="form-control oculto" value="'+resp.unico_impuesto+'" readonly>');
                                    //  $('#texto_contenido').val(response.unico_impuesto);
                                 }
