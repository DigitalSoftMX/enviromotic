function Item(id, id_producto_almacen, codigoBarras, unidad_medida, presentacion, contenido, cantidad, id_producto_requisicion) {
...
//alert(solicitud);
        ...
        if(solicitud == 0)
        {
            var url_action ="../requisicion/search_products_items/"+id_items+"";
        }else{
          if(solicitud == 1){
            var url_action ="requisicion/search_products_items/"+id_items+"";
          }
...
var JSONdataFromServer = '[{"id":"", "id_producto_almacen":"", "codigoBarras":"", "unidad_medida":"", "presentacion":"", "contenido":"", "cantidad":"", "id_producto_requisicion":""}]';
if (requestJson) {
...
var mappedData = ko.utils.arrayMap(dataFromServer, function(item) {
    ...
    return new Item(item.id, item.id_producto_almacen, item.codigoBarras, item.unidad_medida, item.presentacion, item.contenido, item.cantidad, item.id_producto_requisicion);
