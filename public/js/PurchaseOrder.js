$(function () {
        ...
        "aoColumnDefs": [
            ...
            },
            {
                ...
                "mRender": function (data) {
                    return '<input type="text" id="txt_cantidad_servicio_row'+rowCount+'" name="txt_cantidad_servicio_row['+items+']" data-id="'+rowCount+'" onkeypress="return isNumberKey(this);" onkeyup="suma_row_table(this);"  class="form-control" value="' + data + '">';
                }
            },
            {
                ...
                "aTargets": [7],
                "mRender": function (data) {
                    return '<input type="text" id="precio_servicio_row'+rowCount+'" name="precio_servicio_row['+items+']" data-id="'+rowCount+'" onkeypress="return isNumberKey(this);" onkeyup="suma_precio(this);" class="form-control" value="' + data + '">';
                }
            },
       ...
       $("#tabla-requisicion-servicio").dataTable({
        ...
        "aoColumnDefs": [
            ...
            },
            {
                ...
                "aTargets": [3],
                "mRender": function (data) {
                    return '<input type="text" id="iva_servicio_row'+rowCount+'" name="iva_servicio_row['+items+']" data-id="'+rowCount+'" onkeyup="suma_row_iva(this);" class="form-control" value="' + data + '"> ' ;
                }
            },
            {
                "bsortable": false, //SubTotal
  ...
  $("#txt_producto_requisicion").autocomplete({
    ...
    $("#btn_guardar_requisicion").click(function (e) {
        ...
        if ($("#Hora_Entrega").val() === '') {
            toastr.error('', 'Es necesario agregar la hora de entrega');
            $("#Hora_Entrega").focus();
            return;
        }
        if (msg !== '') {
   ...
   $("#tipo_req_compra").on("ifClicked", marcar_compra);
    ...
    function obtenerProductoxNombre(id) {
        var total = '0';
        var existencia = '0';
        $.get('../compras/ajax_listaproductos/' + id, function (data) {
    ...
    $('#month').change(function(){
        var id = $('#month option:selected').find(":selected").text();
        alert(id);
            $.ajax({
