   ...
   <div class="row">
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                       ...
                       {!! Form::open(array('url'=>'rolepermission/edit', 'method' => 'POST', 'class' =>'form-add-perm', 'name' => 'f1')) !!}
                       ...
                       {!!Form::hidden('operation', 1)!!}
                        ...
                        <input type="checkbox" name="perfil-sho" @foreach($asignados as $permission)
                        @if($permission->name == 'adminM_perfil-sho')
                        checked="true" 
                        @endif 
                        @endforeach
                        value="perfil-sho" id="checkPerfil" class="pull-right"/></div> 
                        <div class="panel-body">
                        <div class="i-checks"><label> <input type="checkbox" name="perfil-mod" @foreach($asignados as $permission) @if($permission->name == 'adminM_perfil-mod')
                        checked="true" 
                        @endif
                        @endforeach      
                        value="perfil-mod" id="permissions_value" class="checkPerfil"> <i></i>Modificación </label>
                        </div>
                        </div>
                        </div>
                        </div>
                        ...
                        <input type="checkbox" name="area-sho" @foreach($asignados as $permission) @if($permission->name == 'adminM_area-sho')
                        checked="true" 
                        @endif
                        @endforeach       
                        value="area-sho" class="pull-right"/></div>
                        <div class="panel-body">
                        <div class="i-checks"><label> <input type="checkbox" name="area-ins" @foreach($asignados as $permission) @if($permission->name == 'adminM_area-ins')
                        checked="true" 
                        @endif
                        @endforeach
                        value="area-ins" id="permissions_value"  class="checkPerfil"> <i></i>Alta </label>
                        </div>
                        <div class="i-checks"><label> <input type="checkbox" name="area-mod" @foreach($asignados as $permission) @if($permission->name == 'adminM_area-mod')
                        checked="true" 
                        @endif
                        @endforeach
                        id="permissions_value" value="area-mod"  class="checkAlmacen"> <i></i>Modificacón </label>
                        </div>
                        <div class="i-checks"><label> <input type="checkbox" name="area-eli" @foreach($asignados as $permission) @if($permission->name == 'adminM_area-eli')
                        checked="true" 
                        @endif
                        @endforeach
                        ...
                        <input type="checkbox" name="priority-sho" @foreach($asignados as $permission) @if($permission->name == 'adminM_priority-sho')
                        checked="true" 
                        @endif
                        @endforeach
                        value="priority-sho" class="pull-right"/></div>
                        <div class="panel-body">
                        <div class="i-checks"><label> <input type="checkbox" name="priority-ins" @foreach($asignados as $permission) @if($permission->name == 'adminM_priority-ins')
                        checked="true" 
                        @endif
                        @endforeach
                        value="priority-ins" id="permissions_value"  class="checkPerfil"> <i></i>Alta </label>
                        </div>
                        <div class="i-checks"><label> <input type="checkbox" name="priority-mod"  @foreach($asignados as $permission) @if($permission->name == 'adminM_priority-mod')
                        checked="true" 
                        @endif
                        @endforeach
                        id="permissions_value" value="priority-mod"  class="checkAlmacen"> <i></i>Modificacón </label>
                        </div>
                        <div class="i-checks"><label> <input type="checkbox" name="priority-eli" @foreach($asignados as $permission) @if($permission->name == 'adminM_priority-eli')
                        checked="true" 
                        @endif 
                        @endforeach
                      ...
                      <div class="col-md-3">
                        ...
                        <input type="checkbox" name="userarea-sho" @foreach($asignados as $permission) @if($permission->name == 'adminM_userarea-sho')
                        checked="true" 
                        @endif
                        @endforeach
                        value="userarea-sho" class="pull-right"/></div>
                        <div class="panel-body">
                        <div class="i-checks"><label> <input type="checkbox" name="userarea-ins" @foreach($asignados as $permission) @if($permission->name == 'adminM_userarea-ins')
                        checked="true" 
                        @endif
                        @endforeach
                        value="userarea-ins" id="permissions_value"  class="checkPerfil"> <i></i>Alta </label>
                        </div>
                        <div class="i-checks"><label> <input type="checkbox" name="userarea-mod" @foreach($asignados as $permission) @if($permission->name == 'adminM_userarea-mod')
                        checked="true" 
                        @endif
                        @endforeach
                        id="permissions_value" value="userarea-mod"  class="checkAlmacen"> <i></i>Modificacón </label>
                        </div>
                        <div class="i-checks"><label> <input type="checkbox" name="userarea-eli" @foreach($asignados as $permission) @if($permission->name == 'adminM_userarea-eli')
                        checked="true" 
                        @endif
                        @endforeach
...
<div class="col-md-3">
                        ...
                        <input type="checkbox" name="userclient-sho" @foreach($asignados as $permission) @if($permission->name == 'adminM_userclient-sho')
                        checked="true" 
                        @endif
                        @endforeach
                        value="userclient-sho" class="pull-right"/></div>
                        <div class="panel-body">
                        <div class="i-checks"><label> <input type="checkbox" name="userclient-ins" @foreach($asignados as $permission) @if($permission->name == 'adminM_userclient-ins')
                        checked="true" 
                        @endif
                        @endforeach
                        value="userclient-ins" id="permissions_value"  class="checkPerfil"> <i></i>Alta </label>
                        </div>
                        <div class="i-checks"><label> <input type="checkbox" name="userclient-mod" @foreach($asignados as $permission) @if($permission->name == 'adminM_userclient-mod')
                        checked="true" 
                        @endif
                        @endforeach
                        id="permissions_value" value="userclient-mod"  class="checkAlmacen"> <i></i>Modificacón </label>
                        </div>
                        <div class="i-checks"><label> <input type="checkbox" name="userclient-eli" @foreach($asignados as $permission) @if($permission->name == 'adminM_userclient-eli')
                        checked="true" 
                        @endif 
                        @endforeach
...
<div class="col-md-3">
                        ...
                        <input type="checkbox" name="ticket-sho" @foreach($asignados as $permission) @if($permission->name == 'adminM_ticket-sho')
                        checked="true" 
                        @endif
                        @endforeach
                        value="ticket-sho" class="pull-right"/></div>
                        <div class="i-checks"><label> <input type="checkbox" name="ticket-mod" @foreach($asignados as $permission) @if($permission->name == 'adminM_ticket-mod')
                        checked="true" 
                        @endif
                        @endforeach
...
<div class="col-md-3">
                        ...
                        <input type="checkbox" name="seguimiento-sho" @foreach($asignados as $permission) @if($permission->name == 'adminM_seguimiento-sho')
                        checked="true" 
                        @endif
                        @endforeach
                        value="seguimiento-sho" class="pull-right"/></div>
                        <div class="panel-body">
                        <div class="i-checks"><label> <input type="checkbox" name="seguimiento-mod" @foreach($asignados as $permission) @if($permission->name == 'adminM_seguimiento-mod')
                        checked="true" 
                        @endif
                        @endforeach
                        id="permissions_value" value="seguimiento-mod"  class="checkAlmacen"> <i></i>Modificacón </label>
                        </div>
                        <div class="i-checks"><label> <input type="checkbox" name="seguimiento-cerrado" @foreach($asignados as $permission) @if($permission->name == 'adminM_seguimiento-cerrado')
                        checked="true" 
                        @endif 
                        @endforeach
                        id="permissions_value" value="seguimiento-cerrado"  class="checkAlmacen"> <i></i>Cerrado </label>
                        </div>
                        <div class="i-checks"><label> <input type="checkbox" name="seguimiento-ver" @foreach($asignados as $permission) @if($permission->name == 'adminM_seguimiento-ver')
                        checked="true" 
                        @endif
                        @endforeach
...
<div class="col-md-3">
                        ...
                        <input type="checkbox" name="historial-sho" @foreach($asignados as $permission) @if($permission->name == 'adminM_historial-sho')
                        checked="true" 
                        @endif
                        @endforeach
                        value="historial-sho" class="pull-right"/></div>
                        </div>
                        </div>
...
<div class="col-md-3">
                        ...
                        <input type="checkbox" name="reportadmin-sho" @foreach($asignados as $permission) @if($permission->name == 'adminM_reportadmin-sho')
                        checked="true" 
                        @endif
                        @endforeach
                        value="reportadmin-sho" class="pull-right"/></div>
                        </div>
                        </div>
                      ...
                      <div class="col-md-3">
                        ...
                        <input type="checkbox" name="report-sho" @foreach($asignados as $permission) @if($permission->name == 'adminM_report-sho')
                        checked="true" 
                        @endif
                        @endforeach
                        value="report-sho" class="pull-right"/></div>
                        </div>
                        </div>

                  <div class="col-md-3">
                        <div class="panel panel-primary">
                        <div class="panel-heading"><small>Catálogo de Facturación.</small>
                        <input type="checkbox" name="facturation-sho" @foreach($asignados as $permission) @if($permission->name == 'adminM_facturation-sho')
                        checked="true" 
                        @endif
                        @endforeach
                        value="facturation-sho" class="pull-right"/></div>
                        <div class="i-checks"><label> <input type="checkbox" name="facturation-ins" @foreach($asignados as $permission) @if($permission->name == 'adminM_facturation-ins')
                        checked="true" 
                        @endif
                        @endforeach
                        id="permissions_value" value="facturation-ins"  class="checkAlmacen"> <i></i>Agregar </label>
                        </div>
                        <div class="i-checks"><label> <input type="checkbox" name="facturation-mod" @foreach($asignados as $permission) @if($permission->name == 'adminM_facturation-mod')
                        checked="true" 
                        @endif
                        @endforeach
                        id="permissions_value" value="facturation-mod"  class="checkAlmacen"> <i></i>Modificacón </label>
                        </div>
                        </div>
                        </div>
