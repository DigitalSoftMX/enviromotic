        ...
        $('#table_id').DataTable( {
            ...
            "columnDefs": [{
                ...
                "render": function(data, type, row){ 
                        ...
                        if('{{$show}}' == ""){  
return @permission("$mod") '<a href="'+url_edit+data+'" class="btn btn-warning btn-xs"><i class="glyphicon glyphicon-edit"></i></a>' + @endpermission @permission("$ver") '<a href="'+url_ver+data+'" class="btn btn-success btn-xs"><i class="glyphicon glyphicon-th-large"></i></a>' @endpermission
                          }
                          else{            
                            return data
                          }
        ...
        },
        {
           ...
           "render": function(data, type, row){ 
                       ...
                       if('{{$catalog->getUrlPrefix()}}' == "seguimiento"){  
                           if(data != ""){
                              return '<a href="download/'+data+'"><span class="label label-primary">Descargar</span></a> ' 
                           }
                           else{
                            return data     
                           }
