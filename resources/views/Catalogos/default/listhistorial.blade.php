        ...
        $('#table_id').DataTable( {
            ...
            "columnDefs": [{
                ...
                "render": function(data, type, row){ 
                        ...
                        if('{{$show}}' == ""){  
return @permission("$ver") '<a href="'+url_ver+data+'" class="btn btn-success btn-xs"><i class="glyphicon glyphicon-th-large"></i></a>' @endpermission
                          }
                          else{            
                            return data
                          }
           ...
           "render": function(data, type, row){ 
                       ...
                       if('{{$catalog->getUrlPrefix()}}' == "historial"){  
                           if(data != null){
